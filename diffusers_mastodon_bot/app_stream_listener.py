    ...
    def __init__(
        ...
        def exit_toot():
            if boot_msg_cfg.toot_on_start_end:
                self.mastodon.account_update_credentials(display_name=f'[OFF] {self.message_conf.default_bot_name}')
            pass
        ...
        if boot_msg_cfg.toot_on_start_end:
            self.mastodon.account_update_credentials(display_name=f'[ON] {self.message_conf.default_bot_name}')
